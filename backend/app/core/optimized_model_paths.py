...
ANALYZED_MODELS = {
    ...
    "controlnet_openpose": {
        ...
        "size_mb": 2757.8,
        "priority": 5,
        "checkpoints": [{'name': 'diffusion_pytorch_model.bin', 'path': 'diffusion_pytorch_model.bin', 'size_mb': 1378.3, 'type': '.bin'}],  # 상위 3개만
        "total_checkpoints": 1
    },
    "grounding_dino": {
        "name": "grounding_dino",
    ...
    "sam_vit_h": {
        ...
        "size_mb": 7337.6,
        "priority": 9,
        "checkpoints": [{'name': 'pytorch_model.bin', 'path': 'pytorch_model.bin', 'size_mb': 2445.8, 'type': '.bin'}],  # 상위 3개만
        "total_checkpoints": 1
    },
    "shared_encoder": {
        "name": "shared_encoder",
    ...
    "stable_diffusion_inpaint": {
        ...
        "type": "diffusion",
        "step": "step_06_virtual_fitting",
        "path": CHECKPOINTS_ROOT / "stable_diffusion_inpaint",
        "ready": True,
        "size_mb": 14524.7,
        "priority": 1,
        "checkpoints": [{'name': 'sd-v1-5-inpainting.ckpt', 'path': 'sd-v1-5-inpainting.ckpt', 'size_mb': 4067.8, 'type': '.ckpt'}, {'name': 'pytorch_model.fp16.bin', 'path': 'text_encoder/pytorch_model.fp16.bin', 'size_mb': 234.8, 'type': '.bin'}, {'name': 'pytorch_model.bin', 'path': 'text_encoder/pytorch_model.bin', 'size_mb': 469.5, 'type': '.bin'}],  # 상위 3개만
        "total_checkpoints": 9
    },
    "stable_diffusion_v15": {
        ...
        "type": "diffusion",
        "step": "step_06_virtual_fitting",
        "path": CHECKPOINTS_ROOT / "stable_diffusion_v15",
        "ready": True,
        "size_mb": 45070.6,
        "priority": 1,
        "checkpoints": [{'name': 'v1-5-pruned.ckpt', 'path': 'v1-5-pruned.ckpt', 'size_mb': 7346.9, 'type': '.ckpt'}, {'name': 'v1-5-pruned-emaonly.ckpt', 'path': 'v1-5-pruned-emaonly.ckpt', 'size_mb': 4067.8, 'type': '.ckpt'}, {'name': 'pytorch_model.fp16.bin', 'path': 'text_encoder/pytorch_model.fp16.bin', 'size_mb': 234.8, 'type': '.bin'}],  # 상위 3개만
    ...
    "step_03_cloth_segmentation": {
        ...
        "size_mb": 206.7,
        "priority": 5,
        "checkpoints": [{'name': 'mobile_sam.pt', 'path': 'mobile_sam.pt', 'size_mb': 38.8, 'type': '.pt'}],  # 상위 3개만
        "total_checkpoints": 1
    },
    "step_04": {
        "name": "step_04",
