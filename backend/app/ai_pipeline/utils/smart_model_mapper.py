...
class SmartModelPathMapper:
    ...
    def _create_unified_mappings(self) -> Dict[str, Dict[str, Any]]:
        """🔥 통합 모델 매핑 테이블 생성 - 실제 파일 경로 반영"""
        return {
            # Step 05: Cloth Warping - 실제 존재하는 파일들로 수정
            "realvis_xl": {
                ...
                "search_patterns": [
                    ...
                    "step_05_cloth_warping/ultra_models/RealVisXL_V4.0.safetensors"
                ],
            ...
            "vgg16_warping": {
                ...
                "search_patterns": [
                    "step_05_cloth_warping/ultra_models/vgg16_warping_ultra.pth",  # ✅ 실제 파일
                    "vgg16_warping_ultra.pth",
                    "vgg16_warping.pth"
                ],
                "fallback_patterns": ["**/vgg16*warp*.pth", "**/vgg16*.pth"],
                "min_size_mb": 50,  # 크기 요구사항 낮춤
                "priority": 2
            },
            ...
            "vgg19_warping": {
                ...
                "ai_class": "RealVGGModel",
                "search_patterns": [
                    "step_05_cloth_warping/ultra_models/vgg19_warping.pth",  # ✅ 실제 파일
                    "vgg19_warping.pth"
                ],
            ...
            "densenet121": {
                ...
                "search_patterns": [
                    "step_05_cloth_warping/ultra_models/densenet121_ultra.pth",  # ✅ 실제 파일
            ...
            # Step 07: Post Processing - 실제 존재하는 파일들로 수정
            "post_processing_model": {
                "step_class": "PostProcessingStep",
                "ai_class": "RealGFPGANModel",
                "search_patterns": [
                    "step_07_post_processing/ultra_models/densenet161_enhance.pth",  # ✅ 실제 파일
                    "densenet161_enhance.pth",
                    "GFPGANv1.4.pth",
                    "sr_model.pth"
                ],
                "fallback_patterns": ["**/GFPGAN*.pth", "**/enhance*.pth", "**/sr_model*.pth"],
                "min_size_mb": 30,  # 크기 요구사항 낮춤
                "priority": 1
            },
            ...
            "super_resolution": {
                ...
                "search_patterns": [
                    "step_07_post_processing/esrgan_x8_ultra",  # ✅ 실제 파일/폴더
                    "esrgan_x8_ultra",
                    "Real-ESRGAN_x4plus.pth"
                ],
                "fallback_patterns": ["**/esrgan*", "**/ESRGAN*"],
                "min_size_mb": 30,
                "priority": 2
            },
            ...
            "ootdiffusion": {
                ...
                "search_patterns": [
                    ...
                    "step_06_virtual_fitting/ootdiffusion/checkpoints/ootd/ootd_hd/checkpoint-36000/unet_vton/diffusion_pytorch_model.bin"
                ],
