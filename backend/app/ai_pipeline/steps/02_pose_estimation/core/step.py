...
from app.ai_pipeline.steps.base.base_step import BaseStepMixin
...
# 상대 임포트 수정
try:
    from ..config.types import PoseModel, PoseQuality, EnhancedPoseConfig, PoseResult
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.config.types import PoseModel, PoseQuality, EnhancedPoseConfig, PoseResult
...
try:
    from ..analyzers.pose_quality_analyzer import PoseQualityAnalyzer
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.analyzers.pose_quality_analyzer import PoseQualityAnalyzer

try:
    from ..analyzers.pose_geometry_analyzer import PoseGeometryAnalyzer
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.analyzers.pose_geometry_analyzer import PoseGeometryAnalyzer

try:
    from ..processors.pose_processor import PoseProcessor
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.processors.pose_processor import PoseProcessor

try:
    from ..processors.image_processor import ImageProcessor
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.processors.image_processor import ImageProcessor

try:
    from ..processors.keypoint_processor import KeypointProcessor
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.processors.keypoint_processor import KeypointProcessor

try:
    from ..visualizers.pose_visualizer import PoseVisualizer
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.visualizers.pose_visualizer import PoseVisualizer
...
class PoseEstimationStep(BaseStepMixin):
    ...
    def _initialize_pose_estimation_specifics(self):
        ...
        if self.config.enable_ensemble:
            try:
                from ..ensemble.ensemble_manager import PoseEnsembleManager
