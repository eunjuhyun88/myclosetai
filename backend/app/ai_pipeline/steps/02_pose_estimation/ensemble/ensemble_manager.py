...
try:
    ...
    from app.ai_pipeline.steps.02_pose_estimation.config.types import EnhancedPoseConfig

try:
    from .ensemble_system import PoseEnsembleSystem
except ImportError:
    from app.ai_pipeline.steps.02_pose_estimation.ensemble.ensemble_system import PoseEnsembleSystem
