...
class WarpingQuality(Enum):
    """변형 품질"""
    PERFECT = "perfect"        # 95-100점
    EXCELLENT = "excellent"    # 90-94점
    GOOD = "good"              # 80-89점
    ACCEPTABLE = "acceptable"  # 70-79점
    POOR = "poor"              # 60-69점
    VERY_POOR = "very_poor"    # 0-59점
...
# WARPING_CONSTANTS 추가
WARPING_CONSTANTS = {
    'DEFAULT_INPUT_SIZE': DEFAULT_INPUT_SIZE,
    'DEFAULT_TPS_CONTROL_POINTS': DEFAULT_TPS_CONTROL_POINTS,
    'DEFAULT_RAFT_ITERATIONS': DEFAULT_RAFT_ITERATIONS,
    'DEFAULT_CONFIDENCE_THRESHOLD': DEFAULT_CONFIDENCE_THRESHOLD,
    'DEFAULT_QUALITY_THRESHOLD': DEFAULT_QUALITY_THRESHOLD,
    'MAX_WARPING_STRENGTH': 2.0,
    'MIN_WARPING_STRENGTH': 0.1,
    'DEFAULT_WARPING_STRENGTH': 1.0,
    'MAX_TPS_CONTROL_POINTS': 100,
    'MIN_TPS_CONTROL_POINTS': 9,
    'MAX_RAFT_ITERATIONS': 20,
    'MIN_RAFT_ITERATIONS': 1
}
...
MODEL_CONFIGS = {
    'tps': {
        'model_path': 'models/tps_model.pth',
        'input_size': (768, 1024),
        'control_points': 25,
        'confidence_threshold': 0.7
    },
    'raft': {
        'model_path': 'models/raft_model.pth',
        'input_size': (768, 1024),
        'iterations': 12,
        'confidence_threshold': 0.7
    },
    'viton_hd': {
        'model_path': 'models/viton_hd_model.pth',
        'input_size': (768, 1024),
        'confidence_threshold': 0.7
    },
    'vgg': {
    ...
    'densenet': {
        'model_path': 'models/densenet_model.pth',
        'input_size': (224, 224),
        'confidence_threshold': 0.7
    },
    'hr_viton': {
        'model_path': 'models/hr_viton_model.pth',
        'input_size': (1024, 768),
        'confidence_threshold': 0.7
    },
    'acgpn': {
        'model_path': 'models/acgpn_model.pth',
        'input_size': (768, 1024),
        'confidence_threshold': 0.7
    },
    'stylegan': {
        'model_path': 'models/stylegan_model.pth',
        'input_size': (256, 256),
        'confidence_threshold': 0.7
    }
}
